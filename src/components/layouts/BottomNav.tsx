...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed items-center bottom-0 left-0 flex w-full h-[70px] bg-white px-[10px] shadow-base z-[10]">
      <Link
        href="/user/home"
        className={`w-full text-center ${pathname === "/user/home" ? "text-primary" : "text-gray-dark"}`}
      >
      ...
      <Link
        href="/user/favorite"
        className={`w-full text-center ${pathname === "/user/favorite" ? "text-primary" : "text-gray-dark"}`}
      >
      ...
      <Link
        href="/user/goods"
        className={`w-full text-center ${pathname === "/user/goods" ? "text-primary" : "text-gray-dark"}`}
      >
      ...
      <Link
        href="/user/profile"
        className={`w-full text-center ${pathname === "/user/profile" ? "text-primary" : "text-gray-dark"}`}
      >
