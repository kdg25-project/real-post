...
export default function PostInfo({ size = "sm", titleOnly = false }: PostInfoProps) {
    return (
        <div>
            <p className={`${size == "sm" ? "text-[14px]" : "text-[18px] underline"} font-semibold`}>Blue Fork Bistro</p>
